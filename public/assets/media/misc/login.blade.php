		...
		<div class="d-flex flex-column flex-lg-row flex-column-fluid">
						...
						<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="POST"
							...
							<center>
								<img alt="Logo" src="{{ asset('/') }}assets/media/logos/logo-dark.png"
									class="h-40px h-lg-60px" />
							</center>
							<!--begin::Heading-->
							<!--begin::Separator-->
							<div class="separator separator-content my-14">
								<span class="w-125px text-gray-500 fw-semibold fs-7">Masuk ke akun Anda</span>
							</div>
							<!--end::Separator-->
							<!--begin::Input group=-->
							...
							<div class="d-grid mb-10">
								<button type="submit" class="btn btn-primary">
									...
									<span class="indicator-label">Login In</span>
									<!--end::Indicator label-->
								</button>
							</div>
							<!--end::Submit button-->
			...
			<div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2"
				...
				<div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
					...
					<!--end::Image-->
					<!--begin::Title-->
					<h2 class="d-none d-lg-block text-white fs-2qx fw-bolder text-center mb-2">Polipiknik</h2>
					<h2 class="text-white">Bappeda Litbang Kab. Pekalongan</h2>
