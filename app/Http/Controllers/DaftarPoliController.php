            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    <button class="btn btn-icon btn-success ubah" data-bs-toggle="modal" data-bs-target="#modalUbah" 
                        ...
                        data-alamat="' . $row->pasien->alamat . '"
                        data-no_hp="' . $row->pasien->no_hp . '"
                        data-id_poli="' . $row->jadwalPeriksa->dokter->poli->id . '"
                    >
                    ...
                    <button class="btn btn-icon btn-danger hapus" data-bs-toggle="modal" data-id="' . $row->id . '">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
